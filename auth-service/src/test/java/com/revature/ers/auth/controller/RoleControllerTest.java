...
class RoleControllerTest {
    ...
    /** Valid token, wrong role -> 403: @PreAuthorize rejects before the handler runs. */
    @Test
    void getAllRoles_asEmployee_isForbidden() throws Exception {
        mockMvc.perform(get("/roles").with(jwt().authorities(new SimpleGrantedAuthority("ROLE_Employee"))))
